...
<tbody>
	<tr valign="top">
	<th scope="row"><label for="clean_contact_email"><?php echo __('Default to E-mail address')?>:</label></th>
	...
	<th scope="row"><label for="clean_contact_router"><?php echo __('Contact Reasons & Recipients')?>:</label></th>
		<td><textarea name="clean_contact_router" id="clean_contact_router" class="regular-text" style="width:25em;" rows="4"><?php echo get_option('clean_contact_router')?></textarea>
		<div class="description">Separate subjects and recipients with |, one per line, e.g. Zombie Invasion|shaun@inn.org</div>
	</tr>
