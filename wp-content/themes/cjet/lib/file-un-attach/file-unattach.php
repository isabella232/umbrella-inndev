...
if ( !class_exists( 'FileUnattach' ) ) {
	...
	class FileUnattach {
		...
		function define_constant( ) {
			...
			define( 'FUNATTACH_FILE_NAME', basename( __FILE__ ) );
			define( 'FUNATTACH_FOLDER', basename( dirname( __FILE__ ) ) );
			define( 'FUNATTACH_ABSPATH', str_replace( "\\", "/", dirname( __FILE__ ) ) );
			define( 'FUNATTACH_URL', get_stylesheet_directory_uri() . "/lib/" . FUNATTACH_FOLDER . "/" );
		}
