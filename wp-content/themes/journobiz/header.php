...
<?php if ( is_front_page() || is_home() ) largo_render_network_header(); ?>

<div id="page" class="hfeed clearfix">

	<div class="sticky-nav-wrapper">
		<div class="sticky-nav-holder <?php if (!is_front_page() || !is_home()) { ?>show<?php } ?>" data-hide-at-top="<?php echo (is_front_page() || is_home()) ? 'true' : 'false'; ?>">
